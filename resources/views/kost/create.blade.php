...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <form action="{{ route('kost.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="nama_kost" class="form-label">Nama kost</label>
                                <input type="text" class="form-control @error('nama_kost') is-invalid @enderror" name="nama_kost" id="nama_kost" value="{{ old('nama_kost') }}">
                                @error('nama_kost')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('no_wa') is-invalid @enderror" name="no_wa" id="no_wa" value="{{ old('no_wa') }}">
                                @error('no_wa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('luas_kamar') is-invalid @enderror" name="luas_kamar" id="luas_kamar" value="{{ old('luas_kamar') }}" placeholder="Contoh: 3 x 3 m">
                                @error('luas_kamar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <select name="jenis_kost" class="form-select form-select-sm mb-3 @error('jenis_kost') is-invalid @enderror" aria-label="Default select example">
                                ...
                                <option value="Khusus">Khusus(Putri/Putra)</option>
