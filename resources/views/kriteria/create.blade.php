...
<div class="main-content">
    ...
    <div class="content-wrapper">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <form action="{{ route('kriteria.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="kd_kriteria" class="form-label">Kode Kriteria</label>
                                <input readonly type="text" class="form-control @error('kd_kriteria') is-invalid @enderror" name="kd_kriteria" id="kd_kriteria" value="{{ old('kd_kriteria', $kd_kriteria) }}">
                                @error('kd_kriteria')
